<html lang="en" data-bs-theme="dark">
    <?php 
        ...
        $query = "SELECT isCoach FROM users WHERE ID=".$_POST["userId"].";";
        //echo $query;
        $isCoach = 1;
        //$isCoach = ($conn->query($query))->fetch_assoc()["isCoach"];
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="row">
                <?php if($isCoach == 1){include_once 'pieceTrackerHomeCards/testHistoryCard.php';}?>
