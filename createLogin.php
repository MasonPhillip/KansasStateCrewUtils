        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-6 pb-3" style='border: solid 3px #AAA;'>
                ...
                <div class="d-flex justify-content-center">
                    <div class="input-group mb-3 sm-w-100 w-75">
                        <div class="input-group-prepend">
                            <span class="input-group-text rounded-left" style='background-color: #795695' id="basic-addon3">Name</span>
                        </div>
                ...
                <div class="d-flex justify-content-center">
                    <div class="input-group mb-3 w-75">
                        <div class="input-group-prepend rounded-left">
                            <span class="input-group-text" style='background-color: #795695' id="basic-addon3">Discord</span>
                        </div>
                ...
                <div class="d-flex justify-content-center">
                    <div class="input-group mb-3 w-75">
                        <div class="input-group-prepend rounded-left">
                            <span class="input-group-text rounded-left" style='background-color: #795695' id="basic-addon3">Team Code</span>
                        </div>
                ...
                <div class="d-flex justify-content-center">
                    <div class="input-group mb-3 w-75">
                        <div class="input-group-prepend rounded-left">
                            <span class="input-group-text" style='background-color: #795695' id="basic-addon3">Confirm Password</span>
                        </div>
                ...
                <br>
                <div class="d-flex justify-content-center"> 
            	    <button id="loginBtn" class="btn btn-lg" style='background-color: #795695' onClick='newLogin()'>Login</button>
                </div>
            </div>
        </div>
